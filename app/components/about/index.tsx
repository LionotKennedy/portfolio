...
//   // Fonction pour parser le contenu HTML dans les traductions
//   const parseContent = (content: string) => {
//     return content
//       .replace(/<strong>/g, '<strong class="text-foregrounds">')
//       .replace(/<span>/g, '<span class="text-accents font-medium">');
//   };
...
//                 <div className="flex flex-col items-end text-right flex-shrink-0">
//                   <span className="text-xl font-bold text-accent">4</span>
//                   <span className="text-[10px] text-muted-foreground uppercase">{t('personalInfo.sectionsCount') || 'Sections'}</span>
//                 </div>
//               </div>
//             </div>
...
//             <div className="grid grid-cols-3 xs:grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-3 xs:gap-4 md:gap-5 w-full">
//               {svgData.map((s) => (
//                 // {/* 1. NOUVEAU CONTENEUR avec la perspective */}
//                 <div key={s.id} className="group relative w-full h-full [perspective:600px] block">
//                    {/* 2. LA CARTE MODIFIÉE avec origin-bottom et rotateX  */}
//                   <div
...
//                     group-hover:[transform:rotateX(22deg)_scale(0.95)] 
...
//                     {/* Petit effet lumineux au survol comme sur les projets */}
