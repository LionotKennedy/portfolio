...
//           <div className="col-span-8 row-span-2 p-8 rounded-xl flex items-center justify-center
//           bg-background/20 border border-accent/30 border-solid backdrop-blur-[6px] custom-btn">
//             Info
//           </div>
//           <div className="col-span-4 p-8 rounded-xl flex items-center justify-center
//           bg-background/20 border border-accent/30 border-solid backdrop-blur-[6px] custom-btn">
//             25+ clients
//           </div>
//           <div className="col-span-4  p-8 rounded-xl flex items-center justify-center
...
//       <div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full text-content-change">
//         <ItemLayout
//           className="col-span-full lg:col-span-8 row-span-2 flex-col items-start glass-effect custom-btn"
//         >
//           <h2 className="text-xl md:text-2xl text-left w-full capitalize">
//             Architect of Enchantment
//           </h2>
//           <p className="font-light text-xs sm:text-sm md:text-base">
//             My journey in web development is powered by an array of mystical tools
//             and languages, with JavaScript casting the core of my enchantments. I
...
//             digital universe. The ancient arts of the Jamstack empower me to
//             create fast, secure, and dynamic experiences, while my design skills
//             ensure every creation is not only functional but visually captivating.
//             Join me as I continue to explore new spells and technologies to shape
//             the future of the web.
//           </p>
//         </ItemLayout>
//         <ItemLayout
//           className="col-span-full xs:col-span-6 lg:col-span-4 text-accent glass-effect custom-btn"
//         >
//           <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
//             0+ <sub className="font-semibold text-base">clients</sub>
//           </p>
...
//         </ItemLayout>
//         <ItemLayout
//           className="col-span-full lg:col-span-12 row-span-2 grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-2 sm:gap-4 p-4 glass-effect custom-btn"
//         >
//           {svgData.map((s) => (
//             <SvgDisplay key={s.id} data={s} />
//           ))}
//         </ItemLayout>
//         <ItemLayout className="col-span-full">
//           <img
...
// <ItemLayout className={"col-span-full glass-effect custom-btn p-4 md:p-6"}>
//   <h3 className="text-lg md:text-xl font-semibold mb-4">
//     Technologies & Outils
//   </h3>

//   {/* Grille auto-ajustable */}
//   <div className="grid grid-cols-[repeat(auto-fit,minmax(70px,1fr))]
//                   gap-3 xs:gap-4 md:gap-5">
//     {svgData.map((s) => (
//       <SvgDisplay key={s.id} data={s} />
//     ))}
//   </div>
// </ItemLayout>
//           {/* ======= FIN GRILLE D’ICÔNES RESPONSIVE ======= */}
