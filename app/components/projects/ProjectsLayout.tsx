...
//             <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-accent/20 to-whate-500/20 flex items-center justify-center text-accent group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 border border-accent/20">
...
//                 {name}
//               </h2>
//               <p className="text-xs sm:text-sm text-black line-clamp-2 mt-0.5">
//                 {description}
//               </p>
//             </div>
//           </div>
...
//       className="group relative w-full block [perspective:600px]"
//     >
//       {/* 2. CHANGEMENT ICI : rotateX(22deg) au lieu de 12deg, et scale(0.95) */}
//       <div className="relative p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 dark:from-black/20 dark:to-black/10 backdrop-blur-md border border-white/20 dark:border-white/10 hover:border-accent/30 dark:hover:border-accent/30 transition-all duration-700 ease-out origin-bottom group-hover:[transform:rotateX(22deg)_scale(0.95)] group-hover:shadow-2xl group-hover:shadow-accent/20 overflow-hidden h-full">
