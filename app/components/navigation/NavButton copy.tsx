...
// import { Github, Home, Linkedin, NotebookText, Palette, Phone, Twitter, User, Download } from "lucide-react"
// import Link from "next/link"
// import clsx from "clsx"
// import { motion } from "framer-motion";
// import type { JSX } from "react/jsx-runtime"
...
//     case "linkedin": return <Linkedin className="w-full h-auto" strokeWidth={1.5} />
//     case "twitter": return <Twitter className="w-full h-auto" strokeWidth={1.5} />
//     case "resume": return <Download className="w-full h-auto" strokeWidth={1.5} />  // ← Changé en Download
//     default: return <Home className="w-full h-auto" strokeWidth={1.5} />
//   }
// }
...
//         a.href = url;
//         a.download = `CV_Lionot_Razafimandimby_${locale.toUpperCase()}.pdf`;
...
//         window.open(`/${locale === 'en' ? 'resume-en.pdf' : 'resume-fr.pdf'}`, '_blank');
//       }
//     }
//   };
